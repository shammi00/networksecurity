...
class DataIngestion:
    ...
    def split_data_as_train_test_split(self, dataframe: pd.DataFrame):
        ...
        try:
            ...
            logging.info(f"Train Set Shape: {train_data.shape} | Test Set Shape: {test_data.shape}")
            ...
            logging.info(f"Exporting Train Set to {train_file_path}")
            train_data.to_csv(train_file_path, index = False, header = True)
            logging.info(f"Exporting Test Set to {test_file_path}")
